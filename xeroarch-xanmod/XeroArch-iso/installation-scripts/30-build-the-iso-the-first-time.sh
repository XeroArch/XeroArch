...
echo
	...
	isoLabel='XeroArch-'$XeroArch_Version'-x86_64.iso'

	# setting of the general parameters
	archisoRequiredVersion="archiso 79-1"
	buildFolder=$HOME"/XeroArch-build"
	outFolder=$HOME"/XeroArch-out"
	...
	echo "Building version                       : "$XeroArch_Version
...
echo
	...
	#profiledef.sh
	oldname1='iso_name="xeroarch'
	newname1='iso_name="xeroarch'

	oldname2='iso_label="xeroarch'
	newname2='iso_label="xeroarch'
